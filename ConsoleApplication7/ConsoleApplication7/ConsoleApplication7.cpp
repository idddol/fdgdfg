...
void func(vector<Procurement_data> pr) {
    ...
    for (int i = 0; i < arr1.size(); i++) {
        for (int j = 0; j < pr.size(); j++) {
            if (arr1[i] == pr[j].getCourse_of_currency().getData().substr(3, 4)) {
                summa+= pr[j].suminRub();
            }
        }
        cout << "Viruchka za " << arr1[i] << " month: " << summa << endl;
        summa = 0;
    }
}
        ...
        if (answer1) {
            ...
            if (answer2) {
                for (int i = 0; i < procurement_data.size(); i++) {
                    ...
                    cout << procurement_data[i].suminRub() << endl;
                }
            }
            else {
                ofstream fout;
                ...
                for (int i = 0; i < procurement_data.size(); i++) {
                    ...
                    fout << procurement_data[i].suminRub() << endl;
                }
            }
